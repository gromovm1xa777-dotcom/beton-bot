...
async def start(message: Message):
    await message.answer(
        "Вітаємо👋\n\n"
        "Mine — це онлайн платформа з ігровими режимами.\n\n"
        "🔹 Доступ через веб-сторінку\n"
        "🔹 Реєстрація необхідна для доступу\n"
        "Оберіть режим гри 👇\n"
...
async def section_1(call: CallbackQuery):
    await call.message.edit_text(
     ...
     "Після реєстрації для нових гравців доступні:\n"
     "🎁 +100% до першого поповнення\n"
     "🎰 100 безкоштовних спінів\n\n"
     "Бонус активується після першого балансу.\n"
     "💳 Усе, що відкрутили, можна вивести)\n\n"
     "Натисни «ГРАТИ», щоб продовжити 👇"),
